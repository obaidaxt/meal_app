...
Navigator.push(context, MaterialPageRoute(builder: (ctx)=> MealsScreen(meals: [], title: 'Some title'), ),);
    ...
    return Scaffold(
      ...
      body: GridView(
        ...
        children: [
          ...
          for (final category in availableCategories) CategoryGridItem(category: category,onSelectCategory:(){
